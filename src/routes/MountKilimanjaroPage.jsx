...
const MountKilimanjaroPage = () => {
  const { mountKilimanjaroTrips } = data;
  return (
    <Container>
      <div className="banner">
        ...
        <motion.div
          ...
          className="details"
        >
          <h2>Discover the Jewel of Mt Kilimanjaro With African Outback Safaris</h2>
      ...
      >
        {mountKilimanjaroTrips.map((item) => (
          <SwiperSlide className="slide">
            ...
            <div className="details">
              ...
              <div className="buttons">
                ...
                <Link to={"/book-now"} className="link-styles">
                  <button>Book NOW</button>
                </Link>
