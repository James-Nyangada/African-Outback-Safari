...
const NgorongoroPage = () => {
  const { ngorongoroTrips } = data;
  return (
    <Container>
      <div className="banner">
        ...
        <motion.div
          ...
          className="details"
        >
          <h2>Discover the Jewel of Ngorongoro With African Outback Safaris</h2>
